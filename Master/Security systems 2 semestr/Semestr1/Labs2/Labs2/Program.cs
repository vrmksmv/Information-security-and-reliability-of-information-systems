...
namespace Labs2
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            char[] Eng = { 'h', 'e', 'l', 'l', 'o', 'm', 'y', 'd', 'e', 'a', 'r', 'f', 'r', 'i', 'e', 'n', 'd' };
            char[] Belrus = { 'п', 'р', 'ы', 'в', 'i', 'т', 'а', 'н', 'н', 'е', 'м', 'о', 'й', 'д', 'а', 'р', 'а', 'г', 'i', 'c', 'я', 'б', 'а', 'р' };
            ...
            string letters = "01";
            using (StreamReader streamReader = new StreamReader(@"D:\универ\5 сем\ЗИ\Labs2\binary.txt"))
            {
            ...
            q = 1 - p;
            Console.WriteLine("Условная энтропия ");
            double H1 = -1 * p * (Math.Log2(p) / Math.Log(2)) - q * (Math.Log2(q) / Math.Log(2));
