...
class LZ77Compressor:
    ...
    def decompress(self, input_file_path, output_file_path=None,verbose = True):
...
input_file_path = 'X:/BSTU/3 year/5 семестр/Защита инфы/лаб10/lab10/input.txt'
output_file_path = 'X:/BSTU/3 year/5 семестр/Защита инфы/лаб10/lab10/output.txt'
decompressed_file_path = 'X:/BSTU/3 year/5 семестр/Защита инфы/лаб10/lab10/decompressed.txt'
