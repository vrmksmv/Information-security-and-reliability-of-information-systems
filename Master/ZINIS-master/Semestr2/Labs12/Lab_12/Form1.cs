...
namespace Lab_12
{
    public partial class Form1 : Form
    {
        ...
        private void openFile_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog.InitialDirectory = @"F:\Новая папка (2)\Lab_12_стеганография\Lab_12\Lab_12\bin\Debug";
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                Bitmap redBitmap = new Bitmap(400, 400);
                Bitmap greenBitmap = new Bitmap(400, 400);
                Bitmap blueBitmap = new Bitmap(400, 400);
                Bitmap colorBitmap = new Bitmap(400, 400);
                for (int y = 0; y < 400; y++)
                {
                    for (int x = 0; x < 400; x++)
                    {
        ...
        private void stegButton_Click(object sender, EventArgs e)
        {
            ...
            Bitmap resultBitmap = new Bitmap(400, 400);
            for (int y = 0; y < 400; y++)
            {
                for (int x = 0; x < 400; x++)
                {
